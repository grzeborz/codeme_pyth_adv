class Team:
    ...
    def __repr__(self):
        return f'{self.name}[GD:{self.calculate_gd()}]'

    def calculate_gd(self):
    ...
    def __lt__(self, other):
        if self.pts < other.pts:
            ...
            if self.calculate_gd() < other.calculate_gd():
                return True
            return False
...
if __name__ == '__main__':
    ...
    print(f'place\tname\tGD')

    for place, team in enumerate(league_table, start=1):
        print(f'{place}.\t{team.name}\t{team.calculate_gd()}')
